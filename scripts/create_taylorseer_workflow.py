...
output_path = "user/default/workflows/WAN22_TAYLORSEER_WORKING.json"
...
print("\nModel flow:")
print("  High Noise: LoRA 101 --[190]-> TaylorSeer 121 --[229]-> ModelSampling 104 -> Sage3 117 -> KSampler 86")
print("  Low Noise:  LoRA 102 --[189]-> TaylorSeer 122 --[230]-> ModelSampling 103 -> Sage3 118 -> KSampler 85")
print("\n✅ Workflow ready! Now restart ComfyUI to load TaylorSeer custom node.")
